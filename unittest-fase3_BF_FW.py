...
class Test(unittest.TestCase):
    ...
    def test10_minimumPathFW(self):
        print("\n----------------- test10_minimumPathFW ALGORITMO Floyd W (A,B) -----------")
        A=self.m.centers[0]
        B=self.m.centers[1]
    ...
    def test11_minimumPathFW(self):
        print("\n----------------- test11_minimumPathFW: ALGORITMO FW  (A,E) -----------")
        A=self.m.centers[0]
        C=self.m.centers[2]
        E=self.m.centers[4]
        F=self.m.centers[5]
    ...
    def test12_minimumPathFW(self):
        print("\n----------------- test12_minimumPathFW: ALGORITMO FW  (A,F) -----------")
        A=self.m.centers[0]
        C=self.m.centers[2]
        F=self.m.centers[5]
    ...
    def test13_minimumPathFW(self):
        print("\n----------------- test13_minimumPathFW: ALGORITMO FW  (B,E) -----------")
        B=self.m.centers[1]
        C=self.m.centers[2]
        D=self.m.centers[3]
        F=self.m.centers[5]
    ...
    def test14_minimumPathFW(self):
        print("\n----------------- test14_minimumPathFW: ALGORITMO FW  (D,F) -----------")
        C=self.m.centers[2]
        D=self.m.centers[3]
        F=self.m.centers[5]
